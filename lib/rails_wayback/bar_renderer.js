(function () {
  ...
  function fetchBranches() {
    fetch(mount + "/branches", { headers: { Accept: "application/json" } })
      ...
      .then(function (data) {
        branchSel.innerHTML = "";
        const references = data.refs || (data.branches || []).map(function (branch) {
          return { full_name: branch, name: branch, label: branch };
        });
        references.forEach(function (reference) {
          ...
          if (
            reference.full_name === selectedBranch ||
            reference.name === selectedBranch ||
            reference.label === selectedBranch
          ) opt.selected = true;
